---
title: 조코딩 웹개발 5주 완성 2주차 리뷰(1)
date: 2022-07-30 23:00:00 +0900
categories: [조코딩, 웹개발 5주 완성]
tags: [조코딩, 웹개발 5주 완성, 2주차, 리뷰]     # TAG names should always be lowercase
...
> 계정 이름, 속성 이름 등의 입력창에는 어떠한 이름을 적으셔도 상관없습니다. 하지만 영어로 파일 이름을 만드는 것에 익숙해지기 위해 영어로 적으시는 것을 권장드립니다.
{: .prompt-info }